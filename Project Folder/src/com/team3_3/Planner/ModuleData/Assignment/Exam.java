...
public class Exam extends Assignment implements Serializable
{
    ...
    // constructor
    public Exam (String name, String module, String date, int weighting, String startTime, String endTime, int duration, String location) throws ParseException, Semester.ProgressOver100Exception
    {
