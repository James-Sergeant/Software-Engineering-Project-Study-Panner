...
public class Coursework extends Assignment implements Serializable
{
    ...
    // constructor
    public Coursework (String name, String module, String date, int weighting,  String dueTime) throws ParseException, Semester.AssignmentWeightingOutOfBoundsException
    {
